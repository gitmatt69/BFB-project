...
-- ('Laptop', '15-inch laptop', 1, 1, 800.00, 10),
-- ('Office Chair', 'Ergonomic chair', 2, 2, 120.00, 5),
-- ('Notebook', 'A4 ruled notebook', 3, 1, 2.50, 50);
...
-- -- Sample data for PurchaseOrderDetails
...
-- -- Sample data for SalesOrderDetails
